...
const form = (todo) => {
  ...
  const createTaskCheckbox = (task) => {
    ...
    // span.appendChild(createCheckbox(task.data.complete));

    const checkbox = (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.createCheckbox)(task.data.complete);
