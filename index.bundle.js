...
const showDefaultProjectView = () => {
  ...
  const projectShowView = (0,_projects_show__WEBPACK_IMPORTED_MODULE_4__.createShowView)();
  _contentContainer__WEBPACK_IMPORTED_MODULE_5__.contentContainer.clear();
  _contentContainer__WEBPACK_IMPORTED_MODULE_5__.contentContainer.appendChild(projectShowView.render(defaultProject));
};
