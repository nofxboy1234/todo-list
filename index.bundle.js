...
function createForm(todo) {
  ...
  const newTask = (event) => {
    const task = new _models_task_mjs__WEBPACK_IMPORTED_MODULE_0__.Task('Task 1', todo.id);
