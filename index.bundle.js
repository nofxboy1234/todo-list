...
function createForm(todo) {
  ...
  const addTaskToDOM = (task, index) => {
    ...
    const checkbox = (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.createCheckbox)(task.complete, 'task-checkbox');
