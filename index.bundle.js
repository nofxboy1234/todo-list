...
const instanceProperties = {
  create: function () {
    ...
    if (this.resourceSingular.save()) {
      ...
      const todoPersisted = _parameters_todoParameters__WEBPACK_IMPORTED_MODULE_2__.params.data.id ? true : false;
      if (todoPersisted) {
