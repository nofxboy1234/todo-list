...
const addTaskToEditedTasks = (todoParamsTask) => {
  if (!_parameters_todoParameters__WEBPACK_IMPORTED_MODULE_2__.params.data.editedTasks) {
    _parameters_todoParameters__WEBPACK_IMPORTED_MODULE_2__.params.data.editedTasks = [];
  }
  _parameters_todoParameters__WEBPACK_IMPORTED_MODULE_2__.params.data.editedTasks.push(todoParamsTask);
};
