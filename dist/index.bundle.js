...
const form = (todo) => {
  ...
  const updateTasksCompleteStatus = () => {
    ...
    _parameters_todoParameters__WEBPACK_IMPORTED_MODULE_4__.params.data.tasks.forEach((paramsTask, index) => {
