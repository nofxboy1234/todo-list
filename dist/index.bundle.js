...
const addAllProjectsToTodoParams = () => {
  ...
  _models_project__WEBPACK_IMPORTED_MODULE_0__.Project.all().forEach((storedProject, index) => {
  ...
  _parameters_todoParameters__WEBPACK_IMPORTED_MODULE_2__.params.data.projects = existingProjects;
};
    ...
    if (this.resourceSingular.errors.length === 0) {
      if (this.resourceSingular.data.viewToRender) {
        ...
        if (this.resourceSingular.save()) {
          ...
          (0,_renderer__WEBPACK_IMPORTED_MODULE_4__.render)(viewString, viewData);
...
/* harmony export */   existsInStorage: () => (/* binding */ existsInStorage)
/* harmony export */ });
...
const instanceProperties = {
  ...
  validate: function () {
    ...
    if ((0,_model__WEBPACK_IMPORTED_MODULE_1__.existsInStorage)(Todo, 'title', this)) {
...
const getView = () => {
  const view = _renderer__WEBPACK_IMPORTED_MODULE_3__.indexTodo;
  return view;
};
...
const cacheCurrentView = () => {
  ...
  (0,_renderer__WEBPACK_IMPORTED_MODULE_3__.cacheView)(view(project.todos()));
};
...
const newProject = () => {
  ...
  (0,_router__WEBPACK_IMPORTED_MODULE_1__.redirectTo)('GET', _router__WEBPACK_IMPORTED_MODULE_1__.newProjectPath, {}, viewToRender);
};
