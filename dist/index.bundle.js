...
const controllers = () => {
  const data = {
    ...
    tasks: _controllers_todoTasksController__WEBPACK_IMPORTED_MODULE_2__.TasksController,
  };
  return data;
};
